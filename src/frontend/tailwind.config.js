...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        xs: "0 1px 2px 0 oklch(0.12 0.04 252 / 0.05)",
        card: "0 4px 24px 0 oklch(0.12 0.04 252 / 0.08)",
        "card-lg": "0 8px 48px 0 oklch(0.12 0.04 252 / 0.14)",
        teal: "0 4px 24px oklch(0.68 0.17 200 / 0.35)",
        "teal-lg": "0 8px 40px oklch(0.68 0.17 200 / 0.5)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
